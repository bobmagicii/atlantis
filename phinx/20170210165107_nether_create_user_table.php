	...
	//*/
		...
		$this->Execute(
			...
			CREATE TABLE `Users` (
				...
				`Alias` VARCHAR(16) NULL DEFAULT NULL COMMENT 'Alias - aka username',
				`Email` VARCHAR(64) NULL DEFAULT NULL COMMENT 'Email - durr',
				`PHash` VARCHAR(128) NULL DEFAULT NULL COMMENT 'PHash - hash of the password we did not store',
				`PSand` VARCHAR(128) NULL DEFAULT NULL COMMENT 'PSand - shiftable sand for login invalidation',
				PRIMARY KEY (`ID`),
